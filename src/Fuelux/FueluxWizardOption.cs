...
{
    public class FueluxWizardOption : IOptionBuilder, IHtmlString
    {
        private int step;
        private HtmlHelper htmlHelper;
        public Dictionary<string, object> Attributes { get; set; }
        public FueluxWizardOption(HtmlHelper helper)
        {
        ...
        public string ToHtmlString()
        {
            ...
            foreach (var item in Attributes.Where(p => p.Key.StartsWith("step_")))
            {
                ...
                Attributes.TryGetValue("selectedItem", out selectedItem);
                var currentStep = 1;
