...
[assembly: WebResource("Savosh.Component.MaxLenght.bootstrap-maxlength.js", "text/javascript")]
namespace System.Web.Mvc
{
    public static class OtherPlugin
    {
        private const string bootstrap_maxlength_js = "Savosh.Component.MaxLenght.bootstrap-maxlength.js";

        public static MvcHtmlString AddMaxLenghtPlugin(this HtmlHelper helper)
        {
...
");
        ...
        public static MvcHtmlString AddValidationPlugin(this HtmlHelper helper)
        {
